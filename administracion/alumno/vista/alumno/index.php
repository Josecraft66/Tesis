...
<body>
<div class="col-md-12">
        <h1>Alumnos de Administracion</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-around">
                                    <a href="index.php?action=editar&id=<?php echo $alumno['idalumno']; ?>" class="btn btn-sm btn-warning">Editar</a>
                                    <a href="index.php?action=eliminar&id=<?php echo $alumno['idalumno']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Está seguro de que desea eliminar este alumno?');">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
