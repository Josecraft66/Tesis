                    ...
                    <div class="card-body">
                        ...
                        <form action="index.php?action=actualizar" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                value="<?php echo htmlspecialchars($alumno['idalumno']); ?>"  readonly>
                            </div>
                            <div class="mb-3">
                                <label for="alumno" class="form-label">Alumno</label>
                                <input type="text" name="alumno" id="alumno" class="form-control"
                                    value="<?php echo htmlspecialchars($alumno['alumno']); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="apaterno" class="form-label">Apellido Paterno</label>
                                <input type="text" name="apaterno" id="apaterno" class="form-control" 
                                value="<?php echo htmlspecialchars($alumno['apaterno']); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="amaterno" class="form-label">Apellido Materno</label>
                                <input type="text" name="amaterno" id="amaterno" class="form-control" 
                                value="<?php echo htmlspecialchars($alumno['amaterno']); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="direccion" class="form-label">Direccion</label>
                                <input type="text" name="direccion" id="direccion" class="form-control" 
                                value="<?php echo htmlspecialchars($alumno['direccion']); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="telefono" class="form-label">Telefono</label>
                                <input type="text" name="telefono" id="telefono" class="form-control" 
                                value="<?php echo htmlspecialchars($alumno['telefono']); ?>" required>
                            </div>
